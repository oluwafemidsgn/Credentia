export type BlogPost = {
  ...
  excerpt: string;
  img: string;
  category: "guides" | "explainers" | "documents-news";
  lead: string;
...
export const blogPosts: BlogPost[] = [
  ...
  {
    slug: "mastering-remote-work-tools",
    type: "Step-by-step",
    readTime: "8 MIN",
    date: "JUN 2026",
  ...
  {
    slug: "revamping-urban-transport",
    type: "Case Study",
    readTime: "8 MIN",
    date: "JUL 2026",
